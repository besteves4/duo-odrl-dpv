...
def generate_policy(value):
    for v in value:
        ...
        if v == "DUO_0000019":
            restrictions.set((ex.offer, odrl.permission, BNode(value='DUO_0000019_perm')))
            restrictions.set((BNode(value='DUO_0000019_perm'), odrl.target, duodrl.TemplateDataset))
            restrictions.set((BNode(value='DUO_0000019_perm'), odrl.duty, BNode(value='DUO_0000019_perm_duty')))
            restrictions.set((BNode(value='DUO_0000019_perm_duty'), odrl.action, odrl.distribute))
            restrictions.set((BNode(value='DUO_0000019_perm_duty'), odrl.output, duodrl.ResultsOfStudies))
        if v == "DUO_0000020":
            restrictions.set((ex.offer, odrl.permission, BNode(value='DUO_0000020_perm')))
            restrictions.set((BNode(value='DUO_0000020_perm'), odrl.target, duodrl.TemplateDataset))
            restrictions.set((BNode(value='DUO_0000020_perm'), odrl.duty, BNode(value='DUO_0000020_perm_duty')))
            restrictions.set((BNode(value='DUO_0000020_perm_duty'), odrl.action, duodrl.CollaborateWithStudyPI))
        if v == "DUO_0000021":
            restrictions.set((ex.offer, odrl.permission, BNode(value='DUO_0000021_perm')))
            restrictions.set((BNode(value='DUO_0000021_perm'), odrl.target, duodrl.TemplateDataset))
            restrictions.set((BNode(value='DUO_0000021_perm'), odrl.duty, BNode(value='DUO_0000021_perm_duty')))
            restrictions.set((BNode(value='DUO_0000021_perm_duty'), odrl.action, duodrl.ProvideEthicalApproval))
        if v == "DUO_0000022":
            restrictions.set((ex.offer, odrl.permission, BNode(value='DUO_0000022_perm')))
            restrictions.set((BNode(value='DUO_0000022_perm'), odrl.target, duodrl.TemplateDataset))
            restrictions.set((BNode(value='DUO_0000022_perm'), odrl.constraint, BNode(value='DUO_0000022_perm_cons')))
            restrictions.set((BNode(value='DUO_0000022_perm_cons'), odrl.leftOperand, odrl.spatial))
            restrictions.set((BNode(value='DUO_0000022_perm_cons'), odrl.operator, odrl.eq))
            restrictions.set((BNode(value='DUO_0000022_perm_cons'), odrl.rightOperand, duodrl.TemplateLocation))
        if v == "DUO_0000024":
            restrictions.set((ex.offer, odrl.permission, BNode(value='DUO_0000024_perm')))
            restrictions.set((BNode(value='DUO_0000024_perm'), odrl.target, duodrl.TemplateDataset))
            restrictions.set((BNode(value='DUO_0000024_perm'), odrl.duty, BNode(value='DUO_0000024_perm_duty')))
            restrictions.set((BNode(value='DUO_0000024_perm_duty'), odrl.action, odrl.distribute))
            restrictions.set((BNode(value='DUO_0000024_perm_duty'), odrl.output, duodrl.ResultsOfStudies))
            restrictions.set((BNode(value='DUO_0000024_perm_duty'), odrl.constraint, BNode(value='DUO_0000024_perm_cons')))
            restrictions.set((BNode(value='DUO_0000024_perm_cons'), odrl.leftOperand, odrl.dateTime))
            restrictions.set((BNode(value='DUO_0000024_perm_cons'), odrl.operator, odrl.gteq))
            restrictions.set((BNode(value='DUO_0000024_perm_cons'), odrl.rightOperand, duodrl.TemplateStudyResultsPublicationDate))
        if v == "DUO_0000025":
            restrictions.set((ex.offer, odrl.permission, BNode(value='DUO_0000025_perm')))
            restrictions.set((BNode(value='DUO_0000025_perm'), odrl.target, duodrl.TemplateDataset))
            restrictions.set((BNode(value='DUO_0000025_perm'), odrl.constraint, BNode(value='DUO_0000025_perm_cons')))
            restrictions.set((BNode(value='DUO_0000025_perm_cons'), odrl.leftOperand, odrl.elapsedTime))
            restrictions.set((BNode(value='DUO_0000025_perm_cons'), odrl.operator, odrl.lteq))
            restrictions.set((BNode(value='DUO_0000025_perm_cons'), odrl.rightOperand, duodrl.TemplateTimeLimit))
        if v == "DUO_0000026":
            restrictions.set((ex.offer, odrl.permission, BNode(value='DUO_0000026_perm')))
            restrictions.set((BNode(value='DUO_0000026_perm'), odrl.target, duodrl.TemplateDataset))
            restrictions.set((BNode(value='DUO_0000026_perm'), odrl.assignee, BNode(value='DUO_0000026_perm_assignee')))
            restrictions.set((BNode(value='DUO_0000026_perm_assignee'), RDF.type, odrl.Party))
            restrictions.set((BNode(value='DUO_0000026_perm_assignee'), obo.DUO_0000010, duodrl.TemplateUser))
        if v == "DUO_0000027":
            restrictions.set((ex.offer, odrl.permission, BNode(value='DUO_0000027_perm')))
            restrictions.set((BNode(value='DUO_0000027_perm'), odrl.target, duodrl.TemplateDataset))
            restrictions.set((BNode(value='DUO_0000027_perm'), odrl.constraint, BNode(value='DUO_0000027_perm_cons')))
            restrictions.set((BNode(value='DUO_0000027_perm_cons'), odrl.leftOperand, duodrl.Project))
            restrictions.set((BNode(value='DUO_0000027_perm_cons'), odrl.operator, odrl.isA))
            restrictions.set((BNode(value='DUO_0000027_perm_cons'), odrl.rightOperand, duodrl.TemplateProject))
            
            restrictions.set((ex.offer, odrl.prohibition, BNode(value='DUO_0000027_pro')))
            restrictions.set((BNode(value='DUO_0000027_pro'), odrl.target, duodrl.TemplateDataset))
            restrictions.set((BNode(value='DUO_0000027_pro'), odrl.constraint, BNode(value='DUO_0000027_pro_cons')))
            restrictions.set((BNode(value='DUO_0000027_pro_cons'), odrl.leftOperand, duodrl.Project))
            restrictions.set((BNode(value='DUO_0000027_pro_cons'), odrl.operator, duodrl.isNotA))
            restrictions.set((BNode(value='DUO_0000027_pro_cons'), odrl.rightOperand, duodrl.TemplateProject))
        if v == "DUO_0000028":
            restrictions.set((ex.offer, odrl.permission, BNode(value='DUO_0000028_perm')))
            restrictions.set((BNode(value='DUO_0000028_perm'), odrl.target, duodrl.TemplateDataset))
            restrictions.set((BNode(value='DUO_0000028_perm'), odrl.assignee, BNode(value='DUO_0000028_perm_assignee')))
            restrictions.set((BNode(value='DUO_0000028_perm_assignee'), RDF.type, odrl.Party))
            restrictions.set((BNode(value='DUO_0000028_perm_assignee'), obo.DUO_0000010, duodrl.TemplateInstitution))
        if v == "DUO_0000029":
            restrictions.set((ex.offer, odrl.permission, BNode(value='DUO_0000029_perm')))
            restrictions.set((BNode(value='DUO_0000029_perm'), odrl.target, duodrl.TemplateDataset))
            restrictions.set((BNode(value='DUO_0000029_perm'), odrl.duty, BNode(value='DUO_0000029_perm_duty')))
            restrictions.set((BNode(value='DUO_0000029_perm_duty'), odrl.action, duodrl.ReturnDerivedOrEnrichedData))
        if v == "DUO_0000043":
            restrictions.set((ex.offer, odrl.permission, BNode(value='DUO_0000043_perm')))
            restrictions.set((BNode(value='DUO_0000043_perm'), odrl.target, duodrl.TemplateDataset))
            restrictions.set((BNode(value='DUO_0000043_perm'), odrl.constraint, BNode(value='DUO_0000043_perm_cons')))
            restrictions.set((BNode(value='DUO_0000043_perm_cons'), odrl.leftOperand, odrl.purpose))
            restrictions.set((BNode(value='DUO_0000043_perm_cons'), odrl.operator, odrl.isA))
            restrictions.set((BNode(value='DUO_0000043_perm_cons'), odrl.rightOperand, duodrl.CC))
        if v == "DUO_0000044":
            restrictions.set((ex.offer, odrl.prohibition, BNode(value='DUO_0000044_pro')))
            restrictions.set((BNode(value='DUO_0000044_pro'), odrl.target, duodrl.TemplateDataset))
            restrictions.set((BNode(value='DUO_0000044_pro'), odrl.constraint, BNode(value='DUO_0000044_pro_cons')))
            restrictions.set((BNode(value='DUO_0000044_pro_cons'), odrl.leftOperand, odrl.purpose))
            restrictions.set((BNode(value='DUO_0000044_pro_cons'), odrl.operator, odrl.isA))
            restrictions.set((BNode(value='DUO_0000044_pro_cons'), odrl.rightOperand, duodrl.POA))
        if v == "DUO_0000045":
            restrictions.set((ex.offer, odrl.permission, BNode(value='DUO_0000045_perm')))
            restrictions.set((BNode(value='DUO_0000045_perm'), odrl.target, duodrl.TemplateDataset))
            restrictions.set((BNode(value='DUO_0000045_perm'), odrl.assignee, BNode(value='DUO_0000045_perm_assignee')))
            restrictions.set((BNode(value='DUO_0000045_perm_assignee'), RDF.type, odrl.Party))
            restrictions.set((BNode(value='DUO_0000045_perm_assignee'), obo.DUO_0000010, duodrl.NonProfitOrganisation))
        if v == "DUO_0000046":
            restrictions.set((ex.offer, odrl.permission, BNode(value='DUO_0000046_perm')))
            restrictions.set((BNode(value='DUO_0000046_perm'), odrl.target, duodrl.TemplateDataset))
            restrictions.set((BNode(value='DUO_0000046_perm'), odrl.constraint, BNode(value='DUO_0000046_perm_cons')))
            restrictions.set((BNode(value='DUO_0000046_perm_cons'), odrl.leftOperand, odrl.purpose))
            restrictions.set((BNode(value='DUO_0000046_perm_cons'), odrl.operator, odrl.isA))
            restrictions.set((BNode(value='DUO_0000046_perm_cons'), odrl.rightOperand, duodrl.NCU))
            
            restrictions.set((ex.offer, odrl.prohibition, BNode(value='DUO_0000046_pro')))
            restrictions.set((BNode(value='DUO_0000046_pro'), odrl.target, duodrl.TemplateDataset))
            restrictions.set((BNode(value='DUO_0000046_pro'), odrl.constraint, BNode(value='DUO_0000046_pro_cons')))
            restrictions.set((BNode(value='DUO_0000046_pro_cons'), odrl.leftOperand, odrl.purpose))
            restrictions.set((BNode(value='DUO_0000046_pro_cons'), odrl.operator, duodrl.isNotA))
            restrictions.set((BNode(value='DUO_0000046_pro_cons'), odrl.rightOperand, duodrl.NCU))
    return ;
